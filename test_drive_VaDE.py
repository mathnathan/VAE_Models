...
input_dim = (28,28)
encoder = DNN([500,500,2000], tf.nn.elu)
latency_dim = 10
decoder = DNN([2000,500,500], tf.nn.elu)
...
test_data, test_labels = mnist.test.next_batch(200)
labels = []
for tl in test_labels:
    labels.append(np.where(tl)[0][0])
